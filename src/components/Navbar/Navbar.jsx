          ...
          >
            ...
            >
              ...
              <li
                ...
                data-tooltip-content="See All Campaigns"
              >
              ...
              <li
                ...
                data-tooltip-id="my-tooltip"
                data-tooltip-content="Add a Campaign"
              >
              ...
              <li
                ...
                className="hover:text-coral2 text-nowrap"
                data-tooltip-id="my-tooltip"
                data-tooltip-content="See Your Campaigns"
              >
              ...
              <li
                ...
                className="hover:text-coral2 text-nowrap"
                data-tooltip-id="my-tooltip"
                data-tooltip-content="See Your Donations"
              >
            ...
            <div className="flex items-center gap-2 lg:gap-3 relative">
              ...
              <button
                ...
                data-tooltip-id="my-tooltip"
                data-tooltip-content={darkTheme ? 'Light Theme' : 'Dark Theme'}
              >
                <img
